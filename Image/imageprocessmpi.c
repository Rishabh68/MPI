...
/******************************************************************************
  ...
  To compile adapt the code below wo match your filenames:  
	mpicc -o imageprocessmpi imageprocessmpi.c -lglut -lGL -lm -lcrypt

	mpirun -n 5  -quiet ./imageprocessmpi 
...
void detect_edges(unsigned char *in, unsigned char *out) {
  ...
  for(i=0;i<n_pixels;i++) {
	...
	int s, t, u, v; // the pixels adjacent to x,y used for the calculation
